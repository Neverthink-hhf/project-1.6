...
object Operator {
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = sQLcontext.createDataFrame(res).toDF("ispname", "org_num", "val_num", "ad_num",
      "show_num", "click_num", "bid_num", "bidwin_num", "ad_consume", "ad_cost")
    ...
    df.write.mode(SaveMode.Overwrite).jdbc(load.getString("jdbc.url"), "OperatorRpt", prop)
